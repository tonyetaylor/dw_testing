...
class TestSuitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test_suite" do
    assert_difference('TestSuite.count') do
      post test_suites_url, params: { test_suite: { description: @test_suite.description, title: @test_suite.title } }
    end
  ...
  test "should update test_suite" do
    patch test_suite_url(@test_suite), params: { test_suite: { description: @test_suite.description, title: @test_suite.title } }
